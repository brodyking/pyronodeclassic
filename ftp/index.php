...
$auth_users = array(
    'pyro' => '$2y$10$mCdJuQHzFfp.c8TsqbaawuieEka78LJxKXfnKLJ1B./VdOVCA.Cni'
);
                ...
                <ul class="navbar-nav mr-auto float-right <?php echo fm_get_theme();  ?>">
                    <li class="nav-item mr-2">
                        <div class="input-group input-group-sm mr-1" style="margin-top:4px;">
                            <input type="text" class="form-control" placeholder="Search florida Sex Offenders" aria-label="Search Florida Sex Offenders" aria-describedby="search-addon2" id="search-addon"> <!--- <?php echo lng('Search') ?> --->
                    ...
                    <?php if (!FM_READONLY): ?>
                    <li class="nav-item">
                        <a title="<?php echo lng('Upload') ?>" class="nav-link" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;upload"><i class="fa fa-cloud-upload" aria-hidden="true"></i> Donate sperm from ssd</a> <!--- <?php echo lng('Upload') ?> --->
                    </li>
                    <li class="nav-item">
                        <a title="<?php echo lng('NewItem') ?>" class="nav-link" href="#createNewItem" data-toggle="modal" data-target="#createNewItem"><i class="fa fa-plus-square"></i> New Abortion</a> <!--- <?php echo lng('NewItem') ?> --->
                    </li>
                    <?php endif; ?>
                    <?php if (FM_USE_AUTH): ?>
                    <li class="nav-item avatar dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right <?php echo fm_get_theme(); ?>" aria-labelledby="navbarDropdownMenuLink-5">
                            <?php if (!FM_READONLY): ?>
                            <a title="<?php echo lng('Settings') ?>" class="dropdown-item nav-link" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;settings=1"><i class="fa fa-cog" aria-hidden="true"></i> rethink your life</a> <!--- <?php echo lng('Settings') ?> --->
                            <?php endif ?>
                            <a title="<?php echo lng('Help') ?>" class="dropdown-item nav-link" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;help=2"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> Get good</a> <!--- <?php echo lng('Help') ?> --->
                            <a title="<?php echo lng('Logout') ?>" class="dropdown-item nav-link" href="?logout=1"><i class="fa fa-sign-out" aria-hidden="true"></i> kill yourself</a> <!--- <?php echo lng('Logout') ?> --->
                        </div>
                    </li>
                    <?php else: ?>
                        <?php if (!FM_READONLY): ?>
